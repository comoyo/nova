...
var DBParameterGroup = AWSResource.define('AWS::RDS::DBParameterGroup', {
    ...
    Parameters : { type: types.object('rds-db-parameter-group') },
    Tags : { type: types.tags },
});

var RDSSecurityGroupRule = types.object('rds-security-group-rule', {
    CIDRIP: types.string,
    EC2SecurityGroupId: types.string,
...
var DBSecurityGroup = AWSResource.define('AWS::RDS::DBSecurityGroup', {
    ...
    DBSecurityGroupIngress : { type: types.array, required: true }, // array of RDSSecurityGroupRule
...
var EventSubscription = AWSResource.define('AWS::RDS::EventSubscription', {
    ...
    EventCategories : { type: types.array },
    SnsTopicArn : { type: types.string, required: true },
    SourceIds : { type: types.array },
